;10. Faça um Programa que peça a temperatura em graus Celsius, transforme e mostre em graus Fahrenheit. F = (18*C + 320)/10

section .data

    msg1 db "Informe a temperatura em Celsius:",10,0
    len_msg1 equ $-msg1

    msg2 db "Temperatura em graus Fahrenheit: ",0
    len_msg2 equ $-msg2
